...
const updateLog = [
  {
    date: '2024-05-13',
    content: `<h1>更新日志 - Version 1.0.0 (2024-05-13)</h1>
  <ol>
      <li>
          <strong>【表格视图】：</strong>新增功能！现在，经过用户设计的路线经过一定的算法后的规划方案将以清晰的表格视图展示，方便用户查看。
      </li>
      <li>
          <strong>【修改界面】：</strong>新增功能！用户可以轻松进行路线的新增、修改和删除操作，并且可以对单一路线进行个性化设置。
      </li>
      <li>
          <strong>【修改配置】：</strong>新增功能！用户现在可以自定义路线规划的配置，包括保存文件名称、起床准备时间等设置，以更好地满足个性化需求。
      </li>
      <li>
          <strong>【本地存储】：</strong>新增功能！在【修改界面】、【修改配置】和【数据管理】操作后，相关数据将自动保存到本地浏览器中。下次打开页面时，用户可以选择载入本地数据，提供更加便捷的体验。
      </li>
      <li>
          <strong>【数据管理】：</strong>新增功能！用户可以将数据导出为 JSON 文件，也可以从 JSON 文件中导入数据，实现数据的灵活管理和共享。
      </li>
      <li>
          <strong>【更新日志】：</strong>新增功能！现在，每次更新都会在此页面中记录更新内容，让用户了解项目的发展历程。
      </li>
      <li>
          <strong>【支持作者】：</strong>新增功能！如果您喜欢这个项目，您可以在此页面进行捐赠，同时也欢迎您在捐赠中留下关于项目改进的建议。您的支持将是我们不断进步的动力！
      </li>
  </ol>
  <p>感谢您选择使用我们的产品！如果您有任何疑问或建议，请随时联系我们的团队。</p>`,
  },
  {
    date: '2024-05-14',
    content: `<h1>更新日志 - Version 1.1.1 (2024-05-14)</h1>
    <ol>
        <li>
            <strong>修复已知 bug：</strong>修复了一些已知 bug，提升了系统的稳定性和用户体验。
        </li>
        <li>
            <strong>【表格视图】新增功能：</strong>在【表格视图】中新增了【时间分布】饼图的显示，让用户更直观地了解路线时间分布情况。
        </li>
    </ol>
    <p>感谢您的支持！如有任何问题或建议，请随时联系我们。</p>`,
  },
  {
    date: '2024-05-25',
    content: `<h1>更新日志 - Version 1.1.2 (2024-05-25)</h1>
    <ol>
        <li>
            <strong>修复问题：</strong>修复了在传入“路径”后“历时”为类似“1时”这样的时间字符串时，出现“无法生成时间分布饼图”的问题。现在该功能可以正确处理这种时间格式。
        </li>
    </ol>
    <p>感谢您的支持！如有任何问题或建议，请随时联系我们。</p>`,
  },
